...
enum Look {
    ...
    /// accent as `paneFrame`, well down: this one is painted behind a title that still has
    /// to be readable through it, and the ring round the row is what says "split".
