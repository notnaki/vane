    ...
    var body: some View {
        Pane {
            ...
            SettingsCard {
                ...
                Footnote(AppIcon.stamps
                         ? "Shows in the Dock while Vane runs, and stays on Vane in the "
                           + "Finder once it is quit."
                         : "Shows in the Dock while Vane runs. Finder keeps the default "
                           + "icon: Vane is sandboxed, and the sandbox will not let an app "
                           + "write an icon onto its own bundle.")
            }
